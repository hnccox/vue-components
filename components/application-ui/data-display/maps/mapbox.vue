...
onMounted(() => {
	...
	var basemapDark, basemapLight

	basemapDark = 'mapbox://styles/mapbox/dark-v10'
	basemapLight = 'mapbox://styles/mapbox/light-v10'
	...
	// map.addSource('Stadia_AlidadeSmooth', {
  //   "type": "raster",
  //   "tiles": [
  ...
  //   "maxzoom": 14
	...
	// map.addSource('Stadia_AlidadeSmoothDark', {
  //   "type": "raster",
  //   "tiles": [
  ...
  //   "maxzoom": 14
	...
	if(colorScheme == "dark"){
		...
		// 	'type': 'raster',
		// 	'source': 'Stadia_AlidadeSmoothDark',
		// })
	}
